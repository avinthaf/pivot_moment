    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="grid grid-cols-8 border-b border-gray-200">
          <div className="w-20 flex items-center justify-center h-16">
            <Flex className="w-full h-full">
              <Flex align="center" justify="center" className="border-r border-gray-200 flex-1 h-full">
                <IconButton size="1" variant="ghost" onClick={() => navigate('prev')} className="flex-1 h-full">
                  <ArrowLeftIcon />
        ...
        <div className="flex">
          ...
          <div className="flex-1 grid grid-cols-7">
            {days.map((day, dayIndex) => {
              ...
              return (
                <div key={dayIndex} className={`${dayIndex === days.length - 1 ? '' : 'border-r border-gray-200'}`}>
        ...
        <div className="grid grid-cols-7">
          {days.map((day, index) => {
            ...
            return (
              <div
                key={index}
                className={`min-h-[80px] p-2 ${!isLastColumn ? 'border-r border-gray-200' : ''
